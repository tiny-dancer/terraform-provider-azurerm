...
func (t HPCCacheResource) Exists(ctx context.Context, clients *clients.Client, state *terraform.InstanceState) (*bool, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("retrieving HPC Cache %q (Resource Group %q): %+v", id.Name, id.ResourceGroup, err)
	}
